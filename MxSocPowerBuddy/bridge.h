...
typedef struct {
    ...
    CFDictionaryRef pwrsamp_a;
    CFDictionaryRef pwrsamp_b;
    ...
    CFDictionaryRef cpusamp_a;
    CFDictionaryRef cpusamp_b;
} iorep_data;
...
void generatefreqs(static_data*);
void generatecorecnt(static_data*);
void generateextra(static_data*);
